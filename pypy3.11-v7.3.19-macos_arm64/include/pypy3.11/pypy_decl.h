...
PyAPI_FUNC(struct _object *) PyCode_New(int arg0, int arg1, int arg2, int arg3, int arg4, struct _object *arg5, struct _object *arg6, struct _object *arg7, struct _object *arg8, struct _object *arg9, struct _object *arg10, struct _object *arg11, struct _object *arg12, struct _object *arg13, int arg14, struct _object *arg15);
#define PyCode_NewEmpty PyPyCode_NewEmpty
PyAPI_FUNC(PyCodeObject *) PyCode_NewEmpty(const char *arg0, const char *arg1, int arg2);
#define PyCode_NewWithPosOnlyArgs PyPyCode_NewWithPosOnlyArgs
PyAPI_FUNC(PyCodeObject *) PyCode_NewWithPosOnlyArgs(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, struct _object *arg6, struct _object *arg7, struct _object *arg8, struct _object *arg9, struct _object *arg10, struct _object *arg11, struct _object *arg12, struct _object *arg13, struct _object *arg14, int arg15, struct _object *arg16, struct _object *arg17);
...
PyAPI_FUNC(struct _object *) PyContextVar_Reset(struct _object *arg0, struct _object *arg1);
...
#define PyErr_GetHandledException PyPyErr_GetHandledException
...
#define PyErr_SetHandledException PyPyErr_SetHandledException
...
#define PyEval_GetFuncName PyPyEval_GetFuncName
PyAPI_FUNC(const char *) PyEval_GetFuncName(struct _object *arg0);
...
#define PyFrame_GetLineNumber PyPyFrame_GetLineNumber
...
#define PyGC_Collect PyPyGC_Collect
PyAPI_FUNC(int) PyGC_Collect(void);
...
PyAPI_FUNC(size_t) PyLong_AsUnsignedLong(struct _object *arg0);
#define PyLong_AsUnsignedLongLong PyPyLong_AsUnsignedLongLong
PyAPI_FUNC(size_t) PyLong_AsUnsignedLongLong(struct _object *arg0);
#define PyLong_AsUnsignedLongLongMask PyPyLong_AsUnsignedLongLongMask
PyAPI_FUNC(size_t) PyLong_AsUnsignedLongLongMask(struct _object *arg0);
#define PyLong_AsUnsignedLongMask PyPyLong_AsUnsignedLongMask
PyAPI_FUNC(size_t) PyLong_AsUnsignedLongMask(struct _object *arg0);
...
PyAPI_FUNC(struct _object *) PyLong_FromUnsignedLong(size_t arg0);
...
#define PyModule_GetFilenameObject PyPyModule_GetFilenameObject
...
#define PyModule_GetNameObject PyPyModule_GetNameObject
...
#define PyThreadState_GetFrame PyPyThreadState_GetFrame
PyAPI_FUNC(PyFrameObject *) PyThreadState_GetFrame(PyThreadState *arg0);
#define PyThreadState_GetID PyPyThreadState_GetID
...
#define PyUnicode_AsRawUnicodeEscapeString PyPyUnicode_AsRawUnicodeEscapeString
...
#define PyUnicode_DecodeRawUnicodeEscape PyPyUnicode_DecodeRawUnicodeEscape
...
PyAPI_FUNC(struct _object *) _PyLong_FromByteArray(const unsigned char *arg0, size_t arg1, int arg2, int arg3);
...
#define Py_GenericAliasType PyPy_GenericAliasType
...
#define PyExc_BaseExceptionGroup PyPyExc_BaseExceptionGroup
...
#define PyExc_ExceptionGroup PyPyExc_ExceptionGroup
...
#define PyFrame_Type PyPyFrame_Type
